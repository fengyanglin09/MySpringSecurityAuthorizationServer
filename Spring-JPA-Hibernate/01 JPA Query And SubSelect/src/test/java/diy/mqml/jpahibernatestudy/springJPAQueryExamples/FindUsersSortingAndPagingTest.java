 ...
 * ========================================================================
 */
package diy.mqml.jpahibernatestudy.springJPAQueryExamples;


import diy.mqml.jpahibernatestudy.persistence.entity.jpaQuery.User;
...
//        Page<User> userPage = userRepository.findTop3ByActive(true, PageRequest.of(1, 3));
        Page<User> userPage = userRepository.findAll(PageRequest.of(1, 3, Sort.by("registrationDate")));
        List<User> users = userRepository.findFirst2ByLevel(2, Sort.by("registrationDate"));

//        Page<User> userPageSort = userRepository.findAll(PageRequest.of(1, 3), Sort.by("registrationDate"));
